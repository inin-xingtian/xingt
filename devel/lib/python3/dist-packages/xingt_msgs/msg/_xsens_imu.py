...
"""autogenerated by genpy from xingt_msgs/xsens_imu.msg. Do not edit."""
import codecs
import sys
...
class xsens_imu(genpy.Message):
  _md5sum = "0be8442b6411af5cd0fa95a70e55adf9"
  _type = "xingt_msgs/xsens_imu"
...
float64 y
float64 z"""
  __slots__ = ['header','temperature','orientation','orientation_covariance','euler_angles','angular_velocity','angular_velocity_covariance','linear_acceleration','linear_acceleration_covariance','free_acceleration','dv','dq']
  _slot_types = ['std_msgs/Header','float32','geometry_msgs/Quaternion','float64[9]','geometry_msgs/Vector3','geometry_msgs/Vector3','float64[9]','geometry_msgs/Vector3','float64[9]','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Quaternion']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(xsens_imu, self).__init__(*args, **kwds)
      ...
      if self.dq is None:
        self.dq = geometry_msgs.msg.Quaternion()
    else:
      self.header = std_msgs.msg.Header()
      self.temperature = 0.
      self.orientation = geometry_msgs.msg.Quaternion()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_f4d().pack(_x.temperature, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w))
      buff.write(_get_struct_9d().pack(*self.orientation_covariance))
      _x = self
      buff.write(_get_struct_6d().pack(_x.euler_angles.x, _x.euler_angles.y, _x.euler_angles.z, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z))
      ...
      _x = self
      buff.write(_get_struct_10d().pack(_x.free_acceleration.x, _x.free_acceleration.y, _x.free_acceleration.z, _x.dv.x, _x.dv.y, _x.dv.z, _x.dq.x, _x.dq.y, _x.dq.z, _x.dq.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.temperature, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w,) = _get_struct_f4d().unpack(str[start:end])
      start = end
      end += 72
      ...
      (_x.euler_angles.x, _x.euler_angles.y, _x.euler_angles.z, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z,) = _get_struct_6d().unpack(str[start:end])
      start = end
      end += 72
      ...
      (_x.free_acceleration.x, _x.free_acceleration.y, _x.free_acceleration.z, _x.dv.x, _x.dv.y, _x.dv.z, _x.dq.x, _x.dq.y, _x.dq.z, _x.dq.w,) = _get_struct_10d().unpack(str[start:end])
      return self
