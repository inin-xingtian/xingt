...
class pressure_device {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pressure_device(null);
  ...
  static md5sum() {
    ...
    return '521a061d822d4b66da81b38023e72f52';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new pressure_device(null);
...
module.exports = pressure_device;
